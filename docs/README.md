...
5. [`FORGE_SYSTEM_SPEC.md`](FORGE_SYSTEM_SPEC.md)：R1 八类能力、原始状态和覆盖边界的权威产品规格。
...
| `FORGE_SYSTEM_SPEC.md` | 八类能力、原始状态、验收和覆盖边界 | R1 权威产品规格 |
...
文档中出现“设计基线”“候选”“后续阶段”时，表示研究目标或产品假设，不表示当前代码已经存在对应模块。当前代码事实以 `src/`、`tests/`、最近通过的 `npm run check` 和 `PROJECT_PLAN.md` 的现状摘要为准。
