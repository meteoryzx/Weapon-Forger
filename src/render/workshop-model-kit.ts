...
export type MaterialRole = "wood" | "endgrain" | "iron" | "steel" | "stone" | "brick" | "brass" | "dark";
...
export class WorkshopModelKit {
  ...
  constructor() {
    ...
    this.materials={wood:make("#8b6541",0,0.85,true),endgrain:make("#513e30",0,0.93,true),iron:make("#464b4b",0.65,0.65),steel:make("#a3a9a6",0.85,0.32),stone:make("#85877f",0,0.93),brick:make("#ad9275",0,0.98),brass:make("#b59755",0.72,0.44),dark:make("#252a29",0.25,0.9)};
  }
